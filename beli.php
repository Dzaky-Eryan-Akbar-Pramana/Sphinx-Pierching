...
<body>
    ...
    <script>
        ...
        function updateSummary() {
            if (fromCart) {
                // total already calculated server-side
                totalPriceInput.value = <?= intval($total) ?>;
                summaryTotal.textContent = '<?= sanitize_text($priceFormatted) ?>';
                summaryTotalMethod.textContent = '<?= sanitize_text($priceFormatted) ?>';
