...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Sidebar offset — overrides each page's top:0 so logo is never hidden by navbar */
        .sidebar {
        ...
        @media (max-width: 900px) {
            ...
            .cart-bar { padding: 10px 12px; gap: 10px; }
            .cart-bar .logo { font-size: 15px; }
            .cart-dropdown { right: 8px; min-width: calc(100vw - 24px); max-width: 420px; }
